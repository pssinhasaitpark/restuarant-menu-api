...
router.delete("/sub_category/:sub_category_id",verifyToken,menu_management.deleteSubCategory);
...
router.put("/sub_category/:sub_category_id",verifyToken,menu_management.updateSubCategory);
